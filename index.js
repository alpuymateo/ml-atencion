...
async function actualizarDashboard() {
  ...
  try {
    ...
    dashboardCache = {
      ...
      courier_dac: (retirosCache?.dac || []).filter(e => e.etapa === 'en_camino' || e.etapa === 'en_camino_sin_escaneo').length,
      courier_soydelivery: (retirosCache?.soydelivery || []).filter(e => e.etapa === 'en_camino' || e.etapa === 'en_camino_sin_escaneo').length,
      courier_robert: (retirosCache?.robert || []).filter(e => e.etapa === 'en_camino' || e.etapa === 'en_camino_sin_escaneo').length,
